  ...
  return (
    <div
      ...
      className={cn(
        ...
        "focus-within:border-ring/50 focus-within:ring-ring/5 focus-within:ring-[1px]",
...
>(({ className, ...props }, ref) => {
  ...
  return (
    <CommandPrimitive.Input
      ...
      className={cn(
        "flex-1 bg-transparent border-0 outline-none placeholder:text-muted-foreground text-sm",
