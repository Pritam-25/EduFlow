...
import { enrolledCourseType } from "../actions/get-enroll-courses";

export default function EnrollCourseCard({ course }: { course: enrolledCourseType }) {
  ...
  return (
    <Card className="group py-0 gap-0">
      ...
      <CardContent className="p-4">
        ...
        <Link href={`/dashboard/enrolled-courses/${course.slug}`} className={buttonVariants({ className: "mt-4 w-full" })}>
          Watch Course
        </Link>
      </CardContent>
    </Card>
...
export function EnrollCourseCardSkeleton() {
  return (
